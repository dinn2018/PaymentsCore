...
contract RootChannel is Permitable, IRootChannel {
	...
	/**
	 * @notice Send bytes message to Child channel
	 * @param message bytes message that will be sent to Child channel
	...
	/**
	 * @notice Process message received from Child channel
